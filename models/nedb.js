...
db.users_disciplinas = new Datastore("users_disciplinas");
db.users.loadDatabase();
db.disciplinas.loadDatabase();
db.users_disciplinas.loadDatabase();
...
exports.Crud_inscrever = (id_user, id_disciplina) => {
  // inscrição
  return new Promise((resolve, reject) => {
    data = {
      aluno: id_user,
    ...
    db.users_disciplinas.insert(data, (err, dados) => {
      if (err) {
        reject(null);
      } else {
        resolve(dados);
